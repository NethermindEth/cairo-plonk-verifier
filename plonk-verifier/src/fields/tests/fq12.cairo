...
fn fq12_with_issue() -> Fq12 {
    Fq12 {
        c0: fq6(
            from_u256(0xe8d05700cbaab93b441c09983f3685aef9224168ff238592f258563ac99832e),
            from_u256(0x256e979abb0949c663912f0c94c783083b2f9aef60eed3874f0c05b509ece77e),
            from_u256(0x136422ebea152069595d9a5c34c2555c1a73d633dec2ab3948a2d9032aa35902),
            from_u256(0x59fa24a21586beb933cef7182d9fd408e2a6b073d2b3a864b1e22d15715d92a),
            from_u256(0x9b3a0af3cb4d116007cd0403ff969c4394dec287e28978a789a9201f5f349d1),
            from_u256(0x13f5161a12c927da1cd9c1e93f74f171464863e6a3c5eb97477a0d4ec77033d5)
        ),
        c1: fq6(
...
fn axb() -> Fq12 {
    fq12(
        from_u256(0x280d0beb03619826096b4b048e2abb1af592d3d56efa2dc7fd9ce4b9a5b0c1b7),
        from_u256(0x116f1c822ef34231f506b9afd9edb357ce0adb6320f5f929e477df81198b309d),
        from_u256(0x2a42bcd10a9b003bf1f8afd65cf2831d708322383d498a4a1bb3ae5c20a243eb),
        from_u256(0x2a0819f95ecf7e8a4405e1e706726a638550b3b20eebb66b97804be88854e679),
        from_u256(0x2b2cc91cb1e19ce8b66da51c7b08643286216118bb8e062e3827b8c1f6d74e7),
        from_u256(0x214dcdee43ebc72e673cc19f993703e1ad1db17113f7ae41cbddd709380d184d),
        from_u256(0x18aa857acdd6783733aae6be98bf7fa14ac053fbf6f042b35bedf374eb124084),
        from_u256(0x16db5d26558eb13f21bb538eafdef3d71c7738a901361fe37b2b1632c0beca),
        from_u256(0x1a79cd9802cd1685c7c387362a3f2cb31c96b59d100cb38c724ad70077dd940),
        from_u256(0x19e48782b668248e46f48104f64925e8a67006556a09df165e2a0ad5c0bf1cb2),
        from_u256(0x2b9d548b03eb32bac1bb1dd98188668cc01dc7afcf0de68b9f5a35c2ca16813b),
        from_u256(0x18ff99c25f448b082571917c3f5d9b8c6b2ec2956103c0027dbedd72ecd16c6e),
    )
}
...
fn add_sub() {
    let a = fq12(
        u384 { limb0: 34, limb1: 0, limb2: 0, limb3: 0 },
        u384 { limb0: 645, limb1: 0, limb2: 0, limb3: 0 },
        u384 { limb0: 31, limb1: 0, limb2: 0, limb3: 0 },
        u384 { limb0: 55, limb1: 0, limb2: 0, limb3: 0 },
        u384 { limb0: 140, limb1: 0, limb2: 0, limb3: 0 },
        u384 { limb0: 105, limb1: 0, limb2: 0, limb3: 0 },
    ...
    let b = fq12(
        u384 { limb0: 25, limb1: 0, limb2: 0, limb3: 0 },
        u384 { limb0: 45, limb1: 0, limb2: 0, limb3: 0 },
        u384 { limb0: 11, limb1: 0, limb2: 0, limb3: 0 },
        u384 { limb0: 43, limb1: 0, limb2: 0, limb3: 0 },
        u384 { limb0: 86, limb1: 0, limb2: 0, limb3: 0 },
        u384 { limb0: 101, limb1: 0, limb2: 0, limb3: 0 },
    ...
    let c = fq12(
        u384 { limb0: 9, limb1: 0, limb2: 0, limb3: 0 },
        u384 { limb0: 600, limb1: 0, limb2: 0, limb3: 0 },
        u384 { limb0: 20, limb1: 0, limb2: 0, limb3: 0 },
        u384 { limb0: 12, limb1: 0, limb2: 0, limb3: 0 },
        u384 { limb0: 54, limb1: 0, limb2: 0, limb3: 0 },
